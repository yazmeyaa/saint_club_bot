...
export class Createbattlelog1705664224603 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_battle_log" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "battleTime" time NOT NULL, "trophyChange" integer NOT NULL, "userTelegramId" integer)`);
        ...
        await queryRunner.query(`DROP TABLE "user"`);
        await queryRunner.query(`ALTER TABLE "temporary_user" RENAME TO "user"`);
        await queryRunner.query(`CREATE TABLE "temporary_battle_log" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "battleTime" time NOT NULL, "trophyChange" integer NOT NULL, "userTelegramId" integer, CONSTRAINT "FK_e6edc5918d8d5d3a1c440cf1fe4" FOREIGN KEY ("userTelegramId") REFERENCES "user" ("telegram_id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_battle_log"("id", "battleTime", "trophyChange", "userTelegramId") SELECT "id", "battleTime", "trophyChange", "userTelegramId" FROM "battle_log"`);
        await queryRunner.query(`DROP TABLE "battle_log"`);
        await queryRunner.query(`ALTER TABLE "temporary_battle_log" RENAME TO "battle_log"`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "battle_log" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "battleTime" time NOT NULL, "trophyChange" integer NOT NULL, "userTelegramId" integer)`);
