...
export class CreateUserTrophies1705921307447 implements MigrationInterface {
    name = 'CreateUserTrophies1705921307447'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_trophies" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "day" integer NOT NULL DEFAULT (0), "week" integer NOT NULL DEFAULT (0), "month" integer NOT NULL DEFAULT (0))`);
        await queryRunner.query(`CREATE TABLE "temporary_user" ("telegram_id" integer PRIMARY KEY NOT NULL, "player_tag" text, "admin" boolean NOT NULL DEFAULT (0), "trophiesId" integer, CONSTRAINT "UQ_c1ed111fba8a34b812d11f42352" UNIQUE ("telegram_id"), CONSTRAINT "UQ_6753067be967eb35db323425fe5" UNIQUE ("trophiesId"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("telegram_id" integer PRIMARY KEY NOT NULL, "player_tag" text, "admin" boolean NOT NULL DEFAULT (0), "trophiesId" integer, CONSTRAINT "UQ_c1ed111fba8a34b812d11f42352" UNIQUE ("telegram_id"), CONSTRAINT "UQ_6753067be967eb35db323425fe5" UNIQUE ("trophiesId"))`);
